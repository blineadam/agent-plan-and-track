...
| **`copilot-review-instructions`** | Turns `.ai-style-rules.md` into path-scoped `.github/instructions/*.instructions.md` PR-review directives. | Copilot only |
...
skills/copilot-review-instructions/ turn .ai-style-rules.md into Copilot PR-review instructions (Copilot only)
