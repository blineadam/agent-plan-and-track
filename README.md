...
| **`copilot-review-instructions`** | Generates path-scoped `.github/instructions/*.instructions.md` PR-review directives from a project's documented conventions (style rules, instructions file, README, docs). | Copilot only |
...
skills/copilot-review-instructions/ generate Copilot PR-review instructions from a project's documented conventions (Copilot only)
