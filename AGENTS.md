...
- `node .github/scripts/run-check-owned-section-fixtures.js`: exercise the guard that keeps the nightly run inside the `# Code reviews` section of `.github/copilot-instructions.md`, including the fenced-heading and duplicate-heading bypasses (free).
